...
interface IProps extends IBaseProps {
  ...
  createGraphqlErrorBoundaryAction: typeof actions.createGraphqlErrorBoundaryAction;
}
...
class GraphqlErrorBoundary extends React.Component<IProps, IState> {
  ...
  handleRetry() {
    const { createGraphqlErrorBoundaryAction } = this.props;
    this.setState({
      alert: null,
    }, () => {
      createGraphqlErrorBoundaryAction(null);
    });
  }
